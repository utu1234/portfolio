...
const Education = () => {
  ...
  {education.map((edu, index) => (
    ...
    >
      {/* Timeline Circle - Now positioned above content */}
      <div className="relative mb-6 bg-gray-400 border-4 border-[#8245ec] w-16 h-16 rounded-full flex justify-center items-center z-10 mx-auto">
        <img
          src={edu.img}
          alt={edu.school}
